...
Select any chart from the catalog [link](https://github.com/R-Ladies-Warsaw/12-12-2019-ggplot2-workshop/tree/master/GRUPA%205/wykresy) and draw it in ggplot2. Data for individual charts can be found in the data catalog.
Share your graphics with us (link in [README](https://github.com/R-Ladies-Warsaw/12-12-2019-ggplot2-workshop))
